...
int32_t RecognizeBase::recognize_start()
{
    ...
    if (ret != 0)
    {
        ...
        send_app_message("Failed to Load DRP-AI Data.\nRestart the application.");
        return -1;
    }
...
void* RecognizeBase::inference_thread(void* arg)
{
    ...
    while (me->_inf_running)
    {
        ...
        if (0 != ret)
        {
            ...
            me->send_app_message("Failed to run DRPAI_START.\nRestart the application.");
            break;
        }
        inf_cnt++;
        ...
        if (0 == ret)
        {
            ...
            me->send_app_message("Failed to DRP-AI Inference pselect() Timeout.\nRestart the application.");
            break;
        }
        else if (0 > ret)
        {
            ...
            me->send_app_message("Failed to DRP-AI Inference pselect() Error.\nRestart the application.");
        ...
        if (0 == inf_status)
        {
            ...
            if (0 != ret)
            {
                ...
                me->send_app_message("Failed to get result from memory.\nRestart the application.");
                break;
            }
        ...
        else
        {
            ...
            me->send_app_message("Failed to DRPAI Internal Error.\nRestart the application.");
            break;
        }
    }
